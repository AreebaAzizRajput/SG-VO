...
# w/o cross attention, concat rgb orb and use deepest-layer feature
...
class PoseResNet_concat(nn.Module):

    def __init__(self, num_layers = 18, pretrained = True):
        super(PoseResNet_concat, self).__init__()
        self.encoder = ResnetEncoder(num_layers = num_layers, pretrained = pretrained, num_input_images=2, input_image_channel=36)
